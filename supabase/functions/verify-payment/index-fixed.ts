...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (paymentType === "subagent_registration_fee") {
      ...
      // Mark as paid and APPROVED (changed from "paid" to "approved")
      ...
      console.log(`[VERIFY] Subagent registration ${registrationId} payment verified and approved`);

      return new Response(JSON.stringify({
        success: true,
        message: "Registration payment verified successfully and approved",
