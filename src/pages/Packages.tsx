                        ...
                        {isMTNMashup ? (
                          <>
                            ...
                            <div className="space-y-1 text-xs text-white">
                              <div className="flex items-center justify-center gap-2"><Check className="h-4 w-4" />You will receive no SMS when data is delivered so check your current balance before purchase</div>
                            </div>
