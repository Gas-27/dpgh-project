...
return (
  ...
  <TabsContent value="domains" className="mt-0"><DomainDashboardPanel walletBalance={Number(subagentStore?.wallet_balance ?? 0)} walletLabel="Sub-subagent wallet" agentStoreId={subagentStore?.id ?? null} storeKind="subsubagent" /></TabsContent>
