...
export default function OrderNumberApprovalForm({ source, storeId, compact = false }: Props) {
  ...
  function parseValues(value: string) { return value.split(/[\n,;\s]+/).map((item) => item.trim()).filter(Boolean); }
