...
export default function PublicProductsSection({ supportPhone, storeId, storeKind }: { supportPhone?: string | null; storeId?: string | null; storeKind?: string }) {
  ...
  useEffect(() => {
    ...
    ]).then(([globalResult, storeResult]) => {
      const global = (globalResult.data ?? []) as PublicProduct[];
